...
import com.xyz.digital.photo.app.adapter.DevicePhotoAdapter;
...
public class DeviceDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private DevicePhotoAdapter mAdapter;
    ...
    private void initData() {
        ...
        mAdapter = new DevicePhotoAdapter(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.device_detail_manager_bt:
                ToastUtil.showToast(DeviceDetailActivity.this, "待完成");
